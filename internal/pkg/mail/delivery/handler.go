...
func (h *MailHandler) GetDialogues(c echo.Context) error {
	...
	if since == "" {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusBadRequest, errors.New("неверный формат времени параметра since"))
		}
	}
	dialogues, err := h.MailUsecase.GetDialogues(sessionUser.Username, amount, find, folder, sinceTime)
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не удалось получить диалоги"))
	}
...
func (h *MailHandler) CreateDialogue(c echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не получилось создать диалог сорре"))
	}
...
func (h *MailHandler) DeleteDialogue(c echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не удалось удалить диалог"))
	}
...
func (h *MailHandler) DeleteMail(c echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не получилось удалить сообщение"))
	}
...
func (h *MailHandler) GetEmails(c echo.Context) error {
	...
	if email == "" {
		return echo.NewHTTPError(http.StatusBadRequest, errors.New("неверный email собеседника"))
	}
	...
	if err != nil {
		...
		case mail.InvalidEmailError:
			return echo.NewHTTPError(http.StatusBadRequest, errors.New("неверный запрос"))
		default:
			return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не удалось получить письма"))
		}
	}
...
func (h *MailHandler) SendEmail(c echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не удалось отправить письмо"))
	}
...
func (h *MailHandler) GetFolders(c echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не удалось получить папки"))
	}
...
func (h *MailHandler) CreateFolder(c echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не удалось создать папку"))
	}
...
func (h *MailHandler) UpdateFolder(c echo.Context) error {
	...
	if updateFolder.FolderName != nil {
		...
		if err != nil {
			return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не получилось поменять имя папки"))
		}
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не получилось добавить диалог в папку"))
	}
...
func (h *MailHandler) DeleteFolder(c echo.Context) error {
	...
	if err != nil {
		return echo.NewHTTPError(http.StatusInternalServerError, errors.New("не получилось избавиться от папки"))
	}
